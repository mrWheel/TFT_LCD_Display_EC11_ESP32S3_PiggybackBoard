...
pcbThickness        = 7.25; 
standoffHeight      = 14; //-- How much the PCB needs to be raised from the base to leave room for solderings and whatnot
standoffDiameter    = 6;
...
//-------------------------------------------------------------------
pcbStands = 
[//  [3, 3.2, standoffHeight, -1, standoffDiameter+1, standoffPinDiameter, standoffHoleSlack, 0, 0, yappBaseOnly, yappHole, yappAllCorners]
];
...
connectors   = 
[//- 0, 1,     2, 3, 4, 5,       6,      7, 8
    [3, 3.2, -17, 3, 7, 3.5+0.4, 6+0.4, 20, 7
...
cutoutsLid  = 
[
  [(pcbLength/2)-11, (pcbWidth/2), 52, 40, 1, yappRoundedRect, yappCenter]  // Display
// ,[78, pcbWidth-13, 13, 13, 4, yappCircle, yappCenter]    // Rotary Encoder
 ,[78, pcbWidth-13, 12.5, 12.5, 1, yappRoundedRect, yappCenter]    // Rotary Encoder
 ,[78, pcbWidth-31, 13, 13, 3.5, yappCircle, yappCenter]  // Key0
];

cutoutsFront =  
[
    [pcbWidth/2, -12, 10, 1, 1.5, yappRoundedRect, yappCenter]  // USB-C Cutout
];
...
cutoutsLeft =   
[//--  0,  1, 2,  3,   4,   5
    [-11, -5, 0, 11.0, 6.0, yappCircleWithFlats, yappCenter]  // DIN connector
...
snapJoins   =   
[
    [15, 5, yappBack,yappSymmetric]
   ,[12, 5, yappFront, yappSymmetric]
   ,[30, 5, yappLeft, yappRight, yappSymmetric]
];
...
{
  translate([paddingBack+34.5, 27, -0.4])
  {
    color("red")difference()
    {
      cube([56.2,44.1,1], center=true);
      cube([52,40,6], center=true);
    }
  }
